...
@section('content')
    <div class="h-screen flex justify-center items-center flex-col">
        <div class="bg-gray-700 rounded-xl flex justify-center flex-col items-center text-center p-8">
            <div class="h-24 w-80">
            ...
            <a href="{{route('todo.index')}}">
                <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded-full mb-5 m-16">Back
                    <-
                </button>
            </a>
