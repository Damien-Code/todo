...
@section('content')
    {{--    navigation from navigation.blade--}}
            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        ...
                        <x-nav-link href="{{route('todo.index')}}">
                            {{ __('To Do') }}
                        </x-nav-link>
                    </div>
                </div>
    ...
    <div class=" h-48 flex justify-center items-center">
        <a href="{{route('todo.create')}}">
            <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full w-36 h-12">Create
                Todo +
            </button>
        </a>
    </div>
    <div class="grid xl:grid-cols-3 justify-items-center h-screen gap-4 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1">
        @foreach($todos as $todo)
            <div
                class="p-6 w-80  h-48 bg-blue-200 content-center rounded-xl flex flex-col justify-between font-bold overflow-scroll">
                ...
                <div class="flex justify-between">
                    ...
                    <form method="post" action="{{route('todo.destroy', $todo->id)}}">
                        ...
                        @method('DELETE')
                        <button type="submit"
                                class="bg-red-600 hover:bg-red-900 text-white font-bold py-1 px-2 rounded-full">Delete
                        </button>
                    </form>
                </div>
            </div>
